									...
									<td class="text14">&nbsp;&nbsp;
						 			...
						 			<td class="text14">
										...
										&nbsp;<span title="wsbotm"><spring:message code="systema.transportdisp.orders.form.update.label.booking.time"/></span>
						 				...
						 				<input autocomplete="off" onKeyPress="return amountKey(event)" type="text" class="inputTextMediumBlue" name="wsco2" id="wsco2" size="10" maxlength="9" value="${model.record.wsco2}">
