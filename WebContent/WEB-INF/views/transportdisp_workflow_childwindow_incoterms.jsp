			...
			<%-- =====================================================  --%>
          	...
          	<%-- =====================================================  --%>
				...
				<table style="width:100%;"id="containerdatatableTable" cellspacing="2" align="left">
					...
					<table id="incotermsList" class="display compact cell-border" >
						<thead>
						<tr class="tableHeaderField" height="20">
							<th class="text14" title="franka">&nbsp;Kode&nbsp;</th>
		                    <th class="text14" title="beskr">&nbsp;Navn&nbsp;</th>
		                </tr> 
		                </thead>
		                ...
		                <c:forEach var="record" items="${model.incotermsList}" varStatus="counter">    
			               	<tr class="text14">
			               		<td nowrap style="cursor:pointer;" class="textMediumBlue" 
				               		id="code_${record.franka}@text_${record.beskr}" >
