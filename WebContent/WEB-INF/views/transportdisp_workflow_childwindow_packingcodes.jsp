				...
				<table id="containerdatatableTable" cellspacing="2" align="left" width="100%" >
					...
					<table id="packingCodesList" class="display compact cell-border" width="100%" >
						...
						<tr class="tableHeaderField" height="20">
		                    ...
		                    <th class="text14" title="adembg">&nbsp;Tekst&nbsp;</th>
		                    <th class="text14" title="adindx">&nbsp;Len.&nbsp;</th>
		                    <th class="text14" title="adklas">&nbsp;Bre.&nbsp;</th>
		                    <th class="text14" title="adsedd">&nbsp;Høy&nbsp;</th>
		                    <th class="text14" title="adtres">&nbsp;Lm-l&nbsp;</th>
		                    <th class="text14" title="adfakt">&nbsp;Lm-f&nbsp;</th>
		                </tr> 
		                </thead>
		                ...
		                <c:forEach var="record" items="${model.packingCodesList}" varStatus="counter">    
			               <c:choose>           
		               	   ...
		               	   <td class="text14">&nbsp;${record.entext}</td>
		               	   <td class="text14">&nbsp;${record.enlen}</td>
		               	   <td class="text14">&nbsp;${record.enbrd}</td>
			               <td class="text14">&nbsp;${record.enhoy}</td>
			               <td class="text14">&nbsp;${record.enlm}</td>
			               <td class="text14">&nbsp;${record.enlm2}</td>
			            </tr> 
			            </c:forEach>
			            </tbody>
		            </table>
