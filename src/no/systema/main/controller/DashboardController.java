...
public class DashboardController {
	...
	private String getTomcatServerRedirectionUrl(SystemaWebUser appUser, HttpServletRequest request){
		...
		try{
			retval = hostRaw + request.getContextPath() + "/logonWRedDashboard.do?" + "lang=" + appUser.getUsrLang() + "&ru=" + URLEncoder.encode(appUser.getEncryptedUser(), "UTF-8") + "&dp=" + URLEncoder.encode(appUser.getEncryptedPassword(), "UTF-8");
		}catch(Exception e){
