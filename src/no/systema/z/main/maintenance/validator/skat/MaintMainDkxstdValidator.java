 ...
 *
 */
public class MaintMainDkxstdValidator implements Validator {
	private static final Logger logger = LoggerFactory.getLogger(MaintMainDkxstdValidator.class.getName());
	...
	public boolean supports(Class clazz) {
		return JsonMaintMainDkxstdRecord.class.isAssignableFrom(clazz); 
	}
	...
	public void validate(Object obj, Errors errors) { 
		JsonMaintMainDkxstdRecord record = (JsonMaintMainDkxstdRecord)obj;
